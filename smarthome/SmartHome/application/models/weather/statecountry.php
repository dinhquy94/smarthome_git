<?php  
class statecountry extends CI_Model{ 
	...
	public function getCountries($region){
		...
		$countries['South America'] = '|Argentina|Bolivia|Brazil|Chile|Colombia|Ecuador|Guyana|Paraguay|Peru|Suriname|Uruguay|Venezuela';
		$country = Array();
		return explode('|', $countries[$region]);
    ...
    public function getState($country){  
    	...
    	$city_states['Egypt'] = '|Cairo||Ad Daqahliyah|Al Bahr al Ahmar|Al Buhayrah|Al Fayyum|Al Gharbiyah|Al Iskandariyah|Al Ismailiyah|Al Jizah|Al Minufiyah|Al Minya|Al Qahirah|Al Qalyubiyah|Al Wadi al Jadid|Ash Sharqiyah|As Suways|Aswan|Asyut|Bani Suwayf|Burid|Dumyat|Janub Sina|Kafr ash Shaykh|Matruh|Qina|Shamal Sina |Suhaj';
    	...
    	return explode('|', $city_states[$country]);
    } 
